...
# recommended release
_recommended_release = 'light-2603-ina'
...
_supported_light_releases = [
    'light-2505-deimos', 'light-2507-europa', 'light-2509-fornax', 'light-2511-gacrux', 'light-2601-hyperion', 'light-2603-ina'
]
...
class LooseVersion(object):
    """
    A standalone implementation of version number comparisons.
    
    Numeric components are compared numerically, while alphabetic components 
    are compared lexically.

    Replaces the deprecated `distutils.version.LooseVersion` using the 
    backwards-compatible fork at https://github.com/effigies/looseversion.
