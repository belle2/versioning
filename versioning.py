...
# recommended release
_recommended_release = 'light-2303-iriomote'
...
_supported_light_releases = [
    'light-2205-abys', 'light-2210-devonrex', 'light-2212-foldex', 'light-2303-iriomote'
]
...
def recommended_global_tags_v2(release, base_tags, user_tags, metadata):
    ...
    analysis_tags = dict(zip(_all_supported_releases, ['analysis_tools_light-2303-iriomote'] * len(_all_supported_releases)))
