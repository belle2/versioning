...
# recommended release
_recommended_release = 'light-2209-calico'
...
_supported_light_releases = [
    'light-2205-abys', 'light-2207-bengal', 'light-2209-calico'
]
...
def recommended_global_tags_v2(release, base_tags, user_tags, metadata):
    ...
    analysis_tags = dict(zip(_all_supported_releases, ['analysis_tools_light-2207-bengal'] * len(_all_supported_releases)))
