...
# recommended release
_recommended_release = 'light-2203-zeus'
...
_supported_light_releases = [
    'light-2104-poseidon', 'light-2110-tartarus', 'light-2201-venus', 'light-2203-zeus'
]
...
def recommended_global_tags_v2(release, base_tags, user_tags, metadata):
    ...
    analysis_tags = dict(zip(_all_supported_releases, ['analysis_tools_light-2112-uranus'] * len(_all_supported_releases)))
