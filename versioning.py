...
def recommended_global_tags_v2(release, base_tags, user_tags, metadata):
    ...
    analysis_tags = dict(zip(_all_supported_releases, ['analysis_tools_light-2305-korat'] * len(_all_supported_releases)))
...
def performance_recommendation_global_tag():
    """
    Get global tag and payload name of the performance recommendation.
    """

    result = {'global_tag' : 'analysis_performance_recommendation',
